...
class MyWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.point.setGeometry(100, 100, 150, 20)

        self.fx = QLabel('x1', self)
        self.fx.setGeometry(50, 100, 50, 20)
        self.fx.setFont(font)

        self.count = QLineEdit(self)
        self.count.setGeometry(100, 150, 150, 20)

        self.fx = QLabel('точек', self)
        self.fx.setGeometry(50, 150, 50, 20)
        self.fx.setFont(font)

        self.d = QLineEdit(self)
        self.d.setGeometry(100, 200, 150, 20)

        self.fx = QLabel('шаг', self)
        self.fx.setGeometry(50, 200, 50, 20)
        self.fx.setFont(font)

        self.accept_btn = QPushButton(self)
        self.accept_btn.clicked.connect(self.accept)
        self.accept_btn.setGeometry(110, 245, 100, 50)
